  ...
  if (!state?.candidate) {
    return (
      <div className="page" style={{ paddingTop: 120, textAlign: "center" }}>
        <h2 style={{ color: "#111827", marginBottom: 16 }}>No candidate selected</h2>
  ...
  return (
    <div className="page" style={{ paddingTop: 100, paddingBottom: 80 }}>
      <div className="container" style={{ maxWidth: 620, margin: "0 auto" }}>
        ...
        <div style={{
          background: `linear-gradient(135deg, ${party.color}10, #FFFFFF)`,
          border: `1px solid ${party.color}33`, borderRadius: 12, boxShadow: "0 4px 12px rgba(0,0,0,0.05)",
          ...
          <div>
            <p style={{ color: "#475569", fontSize: 12, textTransform: "uppercase", letterSpacing: "0.05em", fontWeight: 700 }}>Voting for</p>
            <p style={{ color: "#111827", fontWeight: 800, fontSize: 18 }}>{candidate.name}</p>
            <p style={{ color: party.color, fontSize: 13, fontWeight: 600 }}>{party.name}</p>
          </div>
        ...
        {step === STEPS.CONFIRM && (
          <div className="card" style={{ textAlign: "center", animation: "fadeInUp 0.5s ease" }}>
            ...
            <h2 style={{ color: "#111827", fontFamily: "'Inter',sans-serif", fontSize: 28, marginBottom: 12, fontWeight: 800 }}>Confirm Your Vote</h2>
        ...
        {step === STEPS.FACE && (
          <div className="card" style={{ animation: "fadeInUp 0.5s ease" }}>
            <h2 style={{ color: "#111827", fontFamily: "'Inter',sans-serif", fontSize: 26, textAlign: "center", marginBottom: 8, fontWeight: 800 }}>
              🧬 Identity Verification
            </h2>
            <p style={{ color: "#475569", fontSize: 13, textAlign: "center", marginBottom: 24, fontWeight: 500 }}>
        ...
        {step === STEPS.PROCESSING && (
          <div className="card" style={{ textAlign: "center", padding: "60px 32px" }}>
            <div className="loader-ring" style={{ margin: "0 auto 24px", borderTopColor: "#1565C0" }} />
            <h3 style={{ color: "#111827", marginBottom: 8, fontWeight: 700 }}>Recording your vote…</h3>
            <p style={{ color: "#475569", fontSize: 13 }}>Writing to blockchain. Please wait.</p>
          </div>
        )}
        ...
        {step === STEPS.SUCCESS && result && (
          <div className="card" style={{ textAlign: "center", animation: "fadeInUp 0.5s ease" }}>
            ...
            <h2 style={{ color: "#138808", fontFamily: "'Inter',sans-serif", fontSize: 32, marginBottom: 8, fontWeight: 800 }}>Vote Cast Successfully!</h2>
            <p style={{ color: "#374151", marginBottom: 4, fontSize: 15 }}>
              Thank you, <strong style={{ color: "#111827" }}>{result.user.firstName}</strong>! Your vote has been recorded.
            </p>
            <p style={{ color: "#6B7280", fontSize: 13, marginBottom: 24 }}>Your vote has been sealed on the blockchain.</p>

            <div style={{ background: "#EDF7ED", border: "1px solid #C8E6C9", borderRadius: 8, padding: "16px 20px", marginBottom: 28, textAlign: "left" }}>
              <p style={{ color: "#2E7D32", fontSize: 11, textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 6, fontWeight: 700 }}>Blockchain Transaction Hash</p>
              <p style={{ color: "#1B5E20", fontSize: 11, fontFamily: "monospace", wordBreak: "break-all", fontWeight: 600 }}>{result.hash}</p>
            </div>
        ...
        {step === STEPS.ERROR && (
          <div className="card" style={{ textAlign: "center", animation: "fadeInUp 0.5s ease" }}>
            ...
            <h2 style={{ color: "#D32F2F", fontFamily: "'Inter',sans-serif", fontSize: 28, marginBottom: 12, fontWeight: 800 }}>Verification Failed</h2>
            <p style={{ color: "#475569", marginBottom: 28, fontSize: 14 }}>{errMsg}</p>
            <div style={{ display: "flex", gap: 12, justifyContent: "center" }}>
